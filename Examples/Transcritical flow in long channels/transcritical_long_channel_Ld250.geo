...
Extrude {0, 0, 1} { Curve{24}; } // surface 28
Intersect Curve {4,8} Surface {28} // Points 19 (bottom) and 20 top
Recursive Delete { Surface{28}; }
Recursive Delete { Point{18}; Point{13}; Point{16}; Point{14}; }

Point(15) = {center-radius, 20, 0, 1.0};
Circle(24) = {19, 15, 20};
Delete { Curve{4}; Curve{8}; }
Line(25) = {4,19};
Line(26) = {19,5};
Line(27) = {8,20};
Line(28) = {20,9};
...
Line Loop(4) = {25,24,28,-22};
Plane Surface(4) = {4};

// Diverging area right
Line Loop(5) = {26,23,27,-24};
Plane Surface(5) = {5};

// Right
Line Loop(6) = {5, 6, 7, -23};
Plane Surface(6) = {6};
...
Include "channel_contraction_Cueto_gradient_Ld250.pos";
