...
void aqtsetcolormapentry_(int *entryIndex, float *r, float *ggrav, float *b)
{
	aqtSetColormapEntry(*entryIndex, *r, *ggrav, *b);
}

void aqtgetcolormapentry_(int *entryIndex, float *r, float *ggrav, float *b)
{
	aqtGetColormapEntry(*entryIndex, r, ggrav, b);
}
...
/*" Color handling "*/
void aqtsetcolor_(float *r, float *ggrav, float *b)
{
	aqtSetColor(*r, *ggrav, *b);
}

void aqtsetbackgroundcolor_(float *r, float *ggrav, float *b)
{
	aqtSetBackgroundColor(*r, *ggrav, *b);
}

void aqtgetcolor_(float *r, float *ggrav, float *b)
{
	aqtGetColor(r, ggrav, b);
}
